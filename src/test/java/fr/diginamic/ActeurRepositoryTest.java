...
public class ActeurRepositoryTest {
	...
	public void testExtraireRealisateursParActeur() {
		TypedQuery<Realisateur> query = em.createQuery("SELECT DISTINCT re FROM Realisateur re JOIN re.films f JOIN f.roles ro JOIN ro.acteur a WHERE a.identite = 'Brad Pitt'", Realisateur.class);
